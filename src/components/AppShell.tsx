...
import { Gamepad2, GraduationCap, Home, KeyRound, Library, LogIn, MessageCircle, PlusCircle, RotateCw, Rss, ScanLine, Search as SearchIcon, ShoppingBag, Sparkles, User, Wrench, X } from "lucide-react";
