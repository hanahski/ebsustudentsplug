...
export const Route = createFileRoute("/bookshelf")({
  head: () => ({
    meta: [
      { title: "My Bookshelf — Books you own on StudentsPlug" },
      ...
      { property: "og:url", content: "https://ebsustudentsplug.fun/bookshelf" },
    ],
    links: [{ rel: "canonical", href: "https://ebsustudentsplug.fun/bookshelf" }],
  }),
